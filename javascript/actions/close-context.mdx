...
- [`verifyCiphertextCiphertextEquality`](/javascript/actions/verify-ciphertext-equality)
...
- [`verifyCiphertextCiphertextEquality`](/javascript/actions/verify-ciphertext-equality) - Create context state for equality proofs
